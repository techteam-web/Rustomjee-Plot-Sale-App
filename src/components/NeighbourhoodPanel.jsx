  ...
  return (
    <div id="nsb">
      ...
      <style>{`
        ...
        .sbt { font-size: 11px; letter-spacing: 0.2em; color: var(--brand-gold); font-weight: 400; }
        ...
        .place-card.here { background: var(--gold-p); border-color: var(--brand-gold); box-shadow: 0 0 12px rgba(26,58,74,0.30); }
        ...
        .place-name { font-size: 12px; font-weight: 400; color: var(--text-primary); }
        ...
        .place-dist { font-size: 11px; font-weight: 400; color: var(--brand-gold); flex-shrink: 0; font-family: 'Inter', sans-serif; }
      `}</style>
    </div>
  );
}
